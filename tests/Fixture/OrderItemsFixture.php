...
class OrderItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'administrator_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'measure_id' => 1,
                'administrator_id' => 1,
                'created' => '2021-02-18 10:39:33',
                'modified' => '2021-02-18 10:39:33',
            ],
        ];
        parent::init();
    }
